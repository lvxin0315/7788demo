...
func main() {
	file, err := os.Open("/Users/lvxin/go/src/simacode/videos/go的语法糖.mp4")
	if err != nil {
		panic(err)
	}
	err, duration := GetMP4Duration(file)
	if err != nil {
		panic(err)
	}
...
func GetMP4Duration(reader io.ReaderAt) (err error, lengthOfTime int) {
